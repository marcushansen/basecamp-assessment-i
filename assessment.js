...
var me = faveNum, myName;
var string= ("My name is marcus and my favorite number is 15");
...
var myName = "notHakeem";
if (marcus = true){
    return true;
}

else if(notHakeem = false){
    return false;
}
...
var responseCreator = function(param){
  if (colorResponse=green){
      return string = ("what is your favorite color");
return string = ("green is ok");
  }
  else if (colorResponse = red){
      return string = ("what is your favorite color");
      return string("i heart red");
  }
...
function greeter (marcus, number19){
return string = ("HI! i am marcus and i am 19 years old")
}
